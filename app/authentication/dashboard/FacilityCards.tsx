...
export function FacilityCard({ title, imageSrc, href }: FacilityCardProps) {
  return (
    <Link href={`/eventspaces/${id}`} className="aspect-square rounded-xl w-full h-full block">
      <Card className="bg-[#556378] flex-row w-full h-full items-center justify-center flex rounded-xl px-4 pb-4 pt-0 hover:bg-[#4a5568] relative overflow-hidden text-[#EEF4ED]">
